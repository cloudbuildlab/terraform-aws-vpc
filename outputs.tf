...
output "vpc_endpoint_dns_entries" {
  ...
  value = {
    ...
    eks_capabilities   = try(aws_vpc_endpoint.eks_capabilities[0].dns_entry, null)
...
output "vpc_endpoint_ids" {
  ...
  value = {
    ...
    eks_capabilities   = try(aws_vpc_endpoint.eks_capabilities[0].id, null)
...
output "vpc_endpoint_network_interface_ids" {
  ...
  value = {
    ...
    eks_capabilities   = try(aws_vpc_endpoint.eks_capabilities[0].network_interface_ids, [])
...
output "vpc_ipv6_cidr" {
  ...
  value       = var.assign_generated_ipv6_cidr_block ? aws_vpc.this.ipv6_cidr_block : null
}
