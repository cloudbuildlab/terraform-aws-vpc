...
|------|-------------|------|---------|:--------:|
| <a name="input_assign_generated_ipv6_cidr_block"></a> [assign\_generated\_ipv6\_cidr\_block](#input\_assign\_generated\_ipv6\_cidr\_block) | Whether to assign AWS-generated IPv6 CIDR block to VPC and subnets at create time. Later changes are ignored on aws\_vpc (lifecycle) so existing IPv6 CIDRs are not stripped; set true at create (or use -replace/CLI) to enable dual-stack. | `bool` | `false` | no |
